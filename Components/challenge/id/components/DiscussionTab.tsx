    ...
    return [
      {
        ...
        message: "¡Hola a todos! ¿Alguien más está emocionado por este desafío? Es mi primera vez participando en un evento de este tipo y me encantaría conocer sus experiencias previas.",
        replies: 3,
        likes: 5,
      ...
      },
      {
        ...
        message: "¿Alguien sabe si necesitamos preparar algo específico para la primera sesión? No quiero llegar sin estar preparado.",
        replies: 2,
        likes: 3,
      ...
      },
      {
        ...
        message: "Estoy buscando compañeros con experiencia en desarrollo frontend para formar un equipo equilibrado. Yo tengo experiencia en backend y bases de datos. ¡Contáctenme si están interesados!",
        replies: 5,
        likes: 8,
    ...
    <div>
      ...
      {showNewPost && (
        <div className="bg-gray-800 rounded-lg p-4 border border-gray-700 mb-6">
          <h3 className="text-lg font-semibold text-white mb-3">Nueva Pregunta o Comentario</h3>
          <Textarea 
        ...
        {filteredDiscussions.length === 0 ? (
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 text-center">
            ...
            <p className="text-gray-300">
              {searchQuery ? "No se encontraron discusiones que coincidan con tu búsqueda." : "No hay discusiones todavía. ¡Sé el primero en publicar!"}
            </p>
          </div>
        ) : (
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-xs text-gray-400">
                      {formatRelativeTime(discussion.date)}
                    </span>
                  </div>
              ...
              <div className="flex justify-between items-center pl-12">
                <div className="flex gap-2">
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`hover:bg-blue-900/30 ${discussion.isLiked ? 'text-blue-400' : 'text-gray-400 hover:text-blue-300'}`}
