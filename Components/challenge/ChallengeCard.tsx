...
export default function ChallengeCard({challenge}: Props) {
    ...
    const displayStatusLabel =
        statusLabels[
            challenge.status as keyof typeof statusLabels
            ] ?? challenge.status;
    ...
    const bannerGradient =
        statusGradient[
            challenge.status as keyof typeof statusGradient
            ] ?? "bg-gray-500";
    ...
    return (
        ...
        >
            ...
            <div className={`h-1 ${bannerGradient}`}></div>
          ...
          >
            ...
            Equipo:{" "}
              ...
              ></span>
                ...
                {/* Fechas */}
                <div
                    className="text-sm text-gray-500 mt-auto mb-6 opacity-70 group-hover:opacity-90 transition-opacity">
                    {challenge.startDate
