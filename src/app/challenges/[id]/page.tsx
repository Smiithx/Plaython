          ...
          <div className="p-8 md:p-10">
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="text-sm text-gray-400">
                Equipo: <strong>{challenge.teamSize} persona{challenge.teamSize !== 1 ? 's' : ''}</strong>
              </div>
            </div>
            ...
            {/* Descripción */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-300 mb-3">Descripción</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div>
                <h2 className="text-xl font-semibold text-gray-300 mb-3">Detalles técnicos</h2>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <span className="text-gray-500 w-24">Dificultad:</span>
                    <span className={`px-3 py-1 rounded-full ${difficultyStyles[challenge.difficulty]}`}>
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-300 mb-3">Tecnologías</h2>
                <div className="flex flex-wrap gap-2">
                  {challenge.tags.map((tag, i) => (
                    <span key={i} className="relative inline-block px-3 py-1.5 rounded-full text-sm font-medium bg-indigo-900/60 text-indigo-200 overflow-hidden group-hover:bg-indigo-700 transition-all duration-300">
            ...
            <div className="mt-12 pt-6 border-t border-gray-800">
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                {(challenge.teamSize ?? 1) > 1 && (
                  <button className="relative py-3 px-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-[1.02] hover:from-purple-700 hover:to-pink-700 overflow-hidden group">
                    <span className="relative z-10">Emparejamiento automático</span>
                    <span className="absolute inset-0 bg-[linear-gradient(45deg,var(--tw-gradient-stops))] from-cyan-400 via-pink-500 to-yellow-500 opacity-0 group-hover:opacity-10 blur-sm scale-110 transition-opacity duration-300"></span>
                  </button>
                )}
              </div>
              ...
              {/* Sección de equipo */}
              <div className="mb-8">
                <h2 className="text-xl font-semibold text-gray-300 mb-4">Equipo</h2>
                <div className="space-y-3">
                  ...
                  {Array.from({ length: (challenge.teamSize || 1) - 1 }).map((_, index) => (
                    <div 
                      key={index} 
              ...
              <div className="text-sm text-gray-500 bg-gray-800/30 p-4 rounded-lg border border-gray-700">
                <p>Una vez inscrito, podrás gestionar tu equipo y acceder a los recursos del reto.</p>
                <p className="mt-2">Para equipos completos, se activará un chat privado y un espacio de colaboración.</p>
              </div>
            </div>
          </div>
        </div>
